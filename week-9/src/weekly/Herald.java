...
public class Herald {
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1 = new JLabel("Bsc(hons) Computer Science");
		...
		txtrInThisModule.setText("In this module you will learn fundamental concepts in computational mathematics, and a particular way of thinking. Both mathematics and computer programming nourish precision thinking, which is necessary for solving problems that require exact solutions.\r\n");
